...
class Question {
    ...
    init(question: String, option01: String, option02: String, option03: String, option04: String, answer: String, answerInfo: String) {
...
let question01 = Question(question  : "This was the only US President to serve more than two consecutive terms.",
                          ...
                          answerInfo: "The only president to serve more than two consecutive terms was, Franklin D. Roosevelt")
...
let question02 = Question(question  : "Which of the following countries has the most residents?",
                          ...
                          option04  : "Vietnam",
                          answer    : "Nigeria",
                          answerInfo: "The country with the most residents is, Nigeria")
...
let question03 = Question(question  : "In what year was the United Nations founded?",
                          ...
                          option04  : "1954",
                          answer    : "1945",
                          answerInfo: "The United Nations was founded in 1945")
...
let question04 = Question(question  : "The Titanic departed from the United Kingdom, where was it supposed to arrive?",
                          ...
                          answerInfo: "The Titanic was supposed to arrive in New York City")
...
let question05 = Question(question  : "Which nation produces the most oil?",
                          ...
                          option04  : "Canada",
                          answer    : "Canada",
                          answerInfo: "The nation the produces the most oil is, Canada")
...
let question06 = Question(question  : "Which country has most recently won consecutive World Cups in Soccer?",
                          ...
                          option04  : "Spain",
                          answer    : "Brazil",
                          answerInfo: "The country that has recently won consecutive World Cups in Soccer is, Brazil")
...
let question07 = Question(question  : "Which of the following rivers is longest?",
                          ...
                          option04  : "Mekong",
                          answer    : "Mississippi",
                          answerInfo: "Mississippi's river is the longest")
...
let question08 = Question(question  : "Which city is the oldest?",
                          ...
                          option04  : "Sydney",
                          answer    : "Mexico City",
                          answerInfo: "The oldest city is, Mexico City")
...
let question09 = Question(question  : "Which country was the first to allow women to vote in national elections?",
                          ...
                          option04  : "Senegal",
                          answer    : "Poland",
                          answerInfo: "The first country to allow women to vote in national elections is, Poland")
...
let question10 = Question(question  : "Which of these countries won the most medals in the 2012 Summer Games?",
                          ...
                          answerInfo: "The country that won the most medals in the 2012 Summer Games is, Great Brittan")
